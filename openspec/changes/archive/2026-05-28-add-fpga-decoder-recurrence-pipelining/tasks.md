...
- [x] 3.3 On-board re-confirm (HARDWARE-GATED — user's board): **CONFIRMED on the
  DE2 (2026-05-27)** — LCD `PASS e=000 it=2` + heartbeat with the demo running on
  the 25 MHz PLL; KEY0 re-runs. Bit-exact verdict at 2× the prior board clock.

## 4. Validate

- [x] 4.1 `npx openspec validate add-fpga-decoder-recurrence-pipelining --strict`
